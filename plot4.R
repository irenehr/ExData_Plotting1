...
plot(home_electricity$DateTime, home_electricity$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
plot(home_electricity$DateTime, home_electricity$Sub_metering_1, col="black", type = "l", ylab = "Energy sub metering", xlab = "")
lines(home_electricity$DateTime, home_electricity$Sub_metering_2, col="red")
lines(home_electricity$DateTime, home_electricity$Sub_metering_3, col="blue")
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd = c(2.5,2.5,2.5), col= c("black", "red", "blue"))
plot(home_electricity$DateTime, home_electricity$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()